...
//        attrStr = [Utility exchangeString:@"" withText:model.msg imageName:@""];
    } else if ([model.msg containsString:@"em2_q"]) {
        if ([model.msg containsString:@"em2_q1"]) {
             attrStr = [Utility emotionStrWithString:@"1" y:-8];
        } else {
            attrStr = [Utility emotionStrWithString:@"2" y:-8];
        }
    } else {
        
        attrStr = [Utility emotionStrWithString:model.msg y:-8];
    }
